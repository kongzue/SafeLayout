...
public class SafeLinearLayout extends LinearLayout {
    ...
    public SafeLinearLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    
    public SafeLinearLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }
    
    public SafeLinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public SafeLinearLayout setAutoPaddingUnsafePath(boolean autoPaddingUnsafePath) {
