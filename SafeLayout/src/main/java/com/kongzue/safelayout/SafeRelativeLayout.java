...
public class SafeRelativeLayout extends RelativeLayout {
    ...
    public SafeRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    
    public SafeRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }
    
    public SafeRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public SafeRelativeLayout setOnSafeInsetsChangeListener(OnSafeInsetsChangeListener onSafeInsetsChangeListener) {
    ...
    public SafeRelativeLayout setAutoPaddingUnsafePath(boolean autoPaddingUnsafePath) {
